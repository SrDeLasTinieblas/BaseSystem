...
// Configuraci�n de Swagger (para desarrollo, staging y producci�n)
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    app.UseSwagger();
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Sistema de Base API v1");
...
// Ejemplo de uso de middleware de permisos global (puedes usarlo por endpoint también)
